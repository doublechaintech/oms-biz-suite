  ...
  render() {
    ...
    const goback = () => {
      ...
      dispatch({
        ...
        payload: { id: owner.id, type: 'secUserBlocking',listName:'Sec User Blocking列表' },
      })
    }
    ...
    return (
      <PageHeaderLayout
        title="新建一个Sec User Blocking"
        content="新建一个Sec User Blocking"
              ...
              <Col lg={12} md={12} sm={24}>
                <Form.Item label={fieldLabels.comments} {...formItemLayout}>
                  {getFieldDecorator('comments', {
                    rules: [{ required: true, message: '请输入Comments' }],
                  })(
