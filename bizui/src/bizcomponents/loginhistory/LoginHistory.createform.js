  ...
  render() {
    ...
    const goback = () => {
      ...
      dispatch({
        ...
        payload: { id: owner.id, type: 'loginHistory',listName:'Login History列表' },
      })
    }
    ...
    return (
      <PageHeaderLayout
        title="新建一个Login History"
        content="新建一个Login History"
              ...
              <Col lg={12} md={12} sm={24}>
                <Form.Item label={fieldLabels.fromIp} {...formItemLayout}>
                  {getFieldDecorator('fromIp', {
                    rules: [{ required: true, message: '请输入From Ip' }],
                  })(
              ...
              <Col lg={12} md={12} sm={24}>
                <Form.Item label={fieldLabels.secUser} {...formItemLayout}>
                  {getFieldDecorator('secUserId', {
                    ...
                    rules: [{ required: true, message: '请输入Sec User' }],
                  })(
