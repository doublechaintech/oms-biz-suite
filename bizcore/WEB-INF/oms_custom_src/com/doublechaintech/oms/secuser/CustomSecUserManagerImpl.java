...
import com.doublechaintech.oms.OmsUserContextImpl;
import com.doublechaintech.oms.LoginForm;
import com.doublechaintech.oms.BaseEntity;
import com.doublechaintech.oms.CommonError;
import com.doublechaintech.oms.DAOGroup;
import com.doublechaintech.oms.ManagerGroup;

import com.doublechaintech.oms.UserContextImpl;
import com.doublechaintech.oms.userapp.UserApp;
import com.doublechaintech.oms.OmsUserContext;
import com.doublechaintech.oms.userapp.*;
import com.doublechaintech.oms.listaccess.*;
import com.doublechaintech.oms.objectaccess.*;
import com.doublechaintech.oms.OmsChecker;
...
public class CustomSecUserManagerImpl extends SecUserManagerImpl implements
    ...
    public String confirmSession(OmsUserContext userContext){
    ...
    public Object resetPassword(OmsUserContext userContext, String mobile, int verifycationCode, String newPassword) {
    ...
    public Object resetPasswordWithoutLogin(OmsUserContext userContext, String loginType, String loginKey, int verifycationCode, String newPassword) {
        SecUser user;
        try {
    ...
    public Object selectApp(OmsUserContext userContext,
    ...
    public SecUser manage(OmsUserContext userContext) throws Exception{
        SecUser user = cachedUser(userContext);
    ...
    protected SecUser cachedUser(OmsUserContext userContext)
    {
        return (SecUser)userContext.getCachedObject(this.getUserKey(userContext), SecUser.class);
    }
    
    public SecUser getCachedSecUser(OmsUserContext userContext) {
    ...
    protected Object gotoApp(OmsUserContext userContext, UserApp app) throws Exception {
    ...
    public String getVerificationCode(OmsUserContext userContext,String mobile){
    ...
    protected void sendVerificationCode(OmsUserContext userContext, String mobile,String code) throws Exception{
    ...
    protected int getRandomVerificationCode(OmsUserContext userContex, int length){
    ...
    protected String getBeanName(OmsUserContext userContext, UserApp app){
    ...
    protected String getTargetObjectId(OmsUserContext userContext, UserApp app){
        
        return  app.getObjectId();
        
    }
    protected String getServiceType(OmsUserContext userContext, UserApp app){
        
        return app.getObjectType();
    }
    protected String getMethodName(OmsUserContext userContext, UserApp app){
    ...
    public Object home(OmsUserContext userContext) {
    ...
    public Object loginWithEmail(OmsUserContext userContext, String email,
            String password) {

        return loginInternal(userContext,"email",email, password);
    
    }
    public Object login(OmsUserContext userContext, String email,
            String password) {
    ...
    public Object loginWithLogin(OmsUserContext userContext, String email,
            String password) {

        return loginInternal(userContext,"login",email, password);
    
    }
    public Object loginWithMobile(OmsUserContext userContext, String email,
            String password) {
        return loginInternal(userContext,"mobile",email, password);
    
    }
    protected SecUser loadUserWith(OmsUserContext userContext, String type, String userId) throws Exception{
    ...
    protected Object loginInternal(OmsUserContext userContext, String type, String userId,
            String password) {
     ...
     */
    protected Object loginTheSecUserInternal(OmsUserContext userContext, SecUser user, String loginComments) throws Exception {
    ...
    public Object showlogin(OmsUserContext userContext) {
    ...
    protected LoginForm showSessionExpired(OmsUserContext userContext) {
    ...
    public BaseUserContext loadUserConext(HttpServletRequest request)
        ...
        OmsUserContextImpl uc = createNewConext(path);
        init(uc, request);
        return uc;
    }
    ...
    protected OmsChecker checker;
    public OmsChecker getChecker(){
        return checker;
    }
    
    public void setChecker(OmsChecker checker){
    ...
    protected void init(UserContextImpl userContext, HttpServletRequest request) {
        ...
        userContext.setChecker((OmsChecker)beanFactory.getBean(getCheckerBeanName()));
    ...
    protected OmsUserContextImpl createNewConext(String path) {

        return new OmsUserContextImpl();
    ...
    public Object checkOtherLogin(OmsUserContext userContext) throws Exception {
	...
	protected void checkUserHasManagementAccess(OmsUserContext userContext, String objectType, String objectId)
	...
	public UserApp updateAppPermission(OmsUserContext userContext, String secUserId, String userAppId, int version,
	...
	public UserApp updateListAccess(OmsUserContext userContext, String secUserId, String userAppId, String displayName,
	...
	public UserApp loadUserAppWithUser(OmsUserContext userContext, String secUserId, String objectType,
    ...
    public Object changeCurUserPassword(OmsUserContext userContext, String currentPassword, String newPassword)
			throws Exception {
	...
	public String testIfHasManagementAccess(OmsUserContext userContext,String objectType,String objectId) {
		try {
			this.checkUserHasManagementAccess(userContext, objectType, objectId);
			return "OK";
		}catch(Exception e){
