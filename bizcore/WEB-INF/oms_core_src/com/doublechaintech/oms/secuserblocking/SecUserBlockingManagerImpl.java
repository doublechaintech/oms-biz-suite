...
public class SecUserBlockingManagerImpl extends CustomOmsCheckerManager implements SecUserBlockingManager {
	...
	protected void throwExceptionWithMessage(String value) throws SecUserBlockingManagerException{
 	...
 	protected SecUserBlocking saveSecUserBlocking(OmsUserContext userContext, SecUserBlocking secUserBlocking, String [] tokensExpr) throws Exception{	
 	...
 	protected SecUserBlocking saveSecUserBlockingDetail(OmsUserContext userContext, SecUserBlocking secUserBlocking) throws Exception{	
 	...
 	public SecUserBlocking loadSecUserBlocking(OmsUserContext userContext, String secUserBlockingId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public SecUserBlocking searchSecUserBlocking(OmsUserContext userContext, String secUserBlockingId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected SecUserBlocking present(OmsUserContext userContext, SecUserBlocking secUserBlocking, Map<String, Object> tokens) throws Exception {
 	...
 	public SecUserBlocking loadSecUserBlockingDetail(OmsUserContext userContext, String secUserBlockingId) throws Exception{	
 	...
 	public Object view(OmsUserContext userContext, String secUserBlockingId) throws Exception{	
 		SecUserBlocking secUserBlocking = loadSecUserBlocking( userContext, secUserBlockingId, viewTokens());
 		return present(userContext,secUserBlocking, allTokens());
		
 	}
 	protected SecUserBlocking saveSecUserBlocking(OmsUserContext userContext, SecUserBlocking secUserBlocking, Map<String,Object>tokens) throws Exception{	
 		return userContext.getDAOGroup().getSecUserBlockingDAO().save(secUserBlocking, tokens);
 	}
 	protected SecUserBlocking loadSecUserBlocking(OmsUserContext userContext, String secUserBlockingId, Map<String,Object>tokens) throws Exception{	
		userContext.getChecker().checkIdOfSecUserBlocking(secUserBlockingId);
		userContext.getChecker().throwExceptionIfHasErrors( SecUserBlockingManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(OmsUserContext userContext, SecUserBlocking secUserBlocking, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(OmsUserContext userContext, SecUserBlocking secUserBlocking, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingSecUserBlocking(OmsUserContext userContext,String secUserBlockingId, int secUserBlockingVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public SecUserBlocking clone(OmsUserContext userContext, String fromSecUserBlockingId) throws Exception{
	...
	public SecUserBlocking internalSaveSecUserBlocking(OmsUserContext userContext, SecUserBlocking secUserBlocking, Map<String,Object> options) throws Exception 
	{
	...
	public SecUserBlocking updateSecUserBlockingProperty(OmsUserContext userContext,String secUserBlockingId, int secUserBlockingVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingSecUserBlocking(userContext, secUserBlockingId, secUserBlockingVersion, property, newValueExpr, tokensExpr);
...
//--------------------------------------------------------------
	...
	public void delete(OmsUserContext userContext, String secUserBlockingId, int secUserBlockingVersion) throws Exception {
	...
	public SecUserBlocking forgetByAll(OmsUserContext userContext, String secUserBlockingId, int secUserBlockingVersion) throws Exception {
		return forgetByAllInternal(userContext, secUserBlockingId, secUserBlockingVersion);		
	}
	protected SecUserBlocking forgetByAllInternal(OmsUserContext userContext,
			String secUserBlockingId, int secUserBlockingVersion) throws Exception{
	...
	protected SecUserBlocking breakWithSecUserByDomain(OmsUserContext userContext, String secUserBlockingId, String domainId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForAddingSecUser(OmsUserContext userContext, String secUserBlockingId, String login, String mobile, String email, String pwd, int verificationCode, DateTime verificationCodeExpire, DateTime lastLoginTime, String domainId,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingSecUserProperties(OmsUserContext userContext, String secUserBlockingId,String id,String login,String mobile,String email,String pwd,int verificationCode,DateTime verificationCodeExpire,DateTime lastLoginTime,String [] tokensExpr) throws Exception {
	...
	public  SecUserBlocking updateSecUserProperties(OmsUserContext userContext, String secUserBlockingId, String id,String login,String mobile,String email,String pwd,int verificationCode,DateTime verificationCodeExpire,DateTime lastLoginTime, String [] tokensExpr) throws Exception
	{	
	...
	protected SecUser createSecUser(OmsUserContext userContext, String login, String mobile, String email, String pwd, int verificationCode, DateTime verificationCodeExpire, DateTime lastLoginTime, String domainId) throws Exception{
	...
	protected void checkParamsForRemovingSecUserList(OmsUserContext userContext, String secUserBlockingId, 
	...
	public  SecUserBlocking removeSecUserList(OmsUserContext userContext, String secUserBlockingId, 
			String secUserIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingSecUser(OmsUserContext userContext, String secUserBlockingId, 
	...
	public  SecUserBlocking removeSecUser(OmsUserContext userContext, String secUserBlockingId, 
		String secUserId, int secUserVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingSecUser(OmsUserContext userContext, String secUserBlockingId, 
		String secUserId, int secUserVersion,String [] tokensExpr) throws Exception{
	...
	public  SecUserBlocking copySecUserFrom(OmsUserContext userContext, String secUserBlockingId, 
		String secUserId, int secUserVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingSecUser(OmsUserContext userContext, String secUserBlockingId, String secUserId, int secUserVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  SecUserBlocking updateSecUser(OmsUserContext userContext, String secUserBlockingId, String secUserId, int secUserVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
