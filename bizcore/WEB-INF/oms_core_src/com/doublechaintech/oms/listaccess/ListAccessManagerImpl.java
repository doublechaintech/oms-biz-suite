...
public class ListAccessManagerImpl extends CustomOmsCheckerManager implements ListAccessManager {
	...
	protected void throwExceptionWithMessage(String value) throws ListAccessManagerException{
 	...
 	protected ListAccess saveListAccess(OmsUserContext userContext, ListAccess listAccess, String [] tokensExpr) throws Exception{	
 	...
 	protected ListAccess saveListAccessDetail(OmsUserContext userContext, ListAccess listAccess) throws Exception{	
 	...
 	public ListAccess loadListAccess(OmsUserContext userContext, String listAccessId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public ListAccess searchListAccess(OmsUserContext userContext, String listAccessId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected ListAccess present(OmsUserContext userContext, ListAccess listAccess, Map<String, Object> tokens) throws Exception {
 	...
 	public ListAccess loadListAccessDetail(OmsUserContext userContext, String listAccessId) throws Exception{	
 		ListAccess listAccess = loadListAccess( userContext, listAccessId, allTokens());
 		return present(userContext,listAccess, allTokens());
		
 	}
 	
 	public Object view(OmsUserContext userContext, String listAccessId) throws Exception{	
 		ListAccess listAccess = loadListAccess( userContext, listAccessId, viewTokens());
 		return present(userContext,listAccess, allTokens());
		
 	}
 	protected ListAccess saveListAccess(OmsUserContext userContext, ListAccess listAccess, Map<String,Object>tokens) throws Exception{	
 		return userContext.getDAOGroup().getListAccessDAO().save(listAccess, tokens);
 	}
 	protected ListAccess loadListAccess(OmsUserContext userContext, String listAccessId, Map<String,Object>tokens) throws Exception{	
		userContext.getChecker().checkIdOfListAccess(listAccessId);
		userContext.getChecker().throwExceptionIfHasErrors( ListAccessManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(OmsUserContext userContext, ListAccess listAccess, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(OmsUserContext userContext, ListAccess listAccess, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingListAccess(OmsUserContext userContext,String listAccessId, int listAccessVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public ListAccess clone(OmsUserContext userContext, String fromListAccessId) throws Exception{
	...
	public ListAccess internalSaveListAccess(OmsUserContext userContext, ListAccess listAccess, Map<String,Object> options) throws Exception 
	{
	...
	public ListAccess updateListAccessProperty(OmsUserContext userContext,String listAccessId, int listAccessVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingListAccess(userContext, listAccessId, listAccessVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherApp(OmsUserContext userContext, String listAccessId, String anotherAppId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(OmsUserContext userContext, String listAccessId, int listAccessVersion) throws Exception {
	...
	public ListAccess forgetByAll(OmsUserContext userContext, String listAccessId, int listAccessVersion) throws Exception {
		return forgetByAllInternal(userContext, listAccessId, listAccessVersion);		
	}
	protected ListAccess forgetByAllInternal(OmsUserContext userContext,
			String listAccessId, int listAccessVersion) throws Exception{
