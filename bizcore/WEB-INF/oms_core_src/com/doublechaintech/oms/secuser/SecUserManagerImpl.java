...
import com.doublechaintech.oms.secuserblocking.CandidateSecUserBlocking;
...
public class SecUserManagerImpl extends CustomOmsCheckerManager implements SecUserManager {
	...
	protected void throwExceptionWithMessage(String value) throws SecUserManagerException{
 	...
 	protected SecUser saveSecUser(OmsUserContext userContext, SecUser secUser, String [] tokensExpr) throws Exception{	
 	...
 	protected SecUser saveSecUserDetail(OmsUserContext userContext, SecUser secUser) throws Exception{	
 	...
 	public SecUser loadSecUser(OmsUserContext userContext, String secUserId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public SecUser searchSecUser(OmsUserContext userContext, String secUserId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected SecUser present(OmsUserContext userContext, SecUser secUser, Map<String, Object> tokens) throws Exception {
 	...
 	public SecUser loadSecUserDetail(OmsUserContext userContext, String secUserId) throws Exception{	
 		SecUser secUser = loadSecUser( userContext, secUserId, allTokens());
 		return present(userContext,secUser, allTokens());
		
 	}
 	
 	public Object view(OmsUserContext userContext, String secUserId) throws Exception{	
 		SecUser secUser = loadSecUser( userContext, secUserId, viewTokens());
 		return present(userContext,secUser, allTokens());
		
 	}
 	protected SecUser saveSecUser(OmsUserContext userContext, SecUser secUser, Map<String,Object>tokens) throws Exception{	
 		return userContext.getDAOGroup().getSecUserDAO().save(secUser, tokens);
 	}
 	protected SecUser loadSecUser(OmsUserContext userContext, String secUserId, Map<String,Object>tokens) throws Exception{	
		userContext.getChecker().checkIdOfSecUser(secUserId);
		userContext.getChecker().throwExceptionIfHasErrors( SecUserManagerException.class);
	...
	public SecUser loadSecUserWithMobile(OmsUserContext userContext, String mobile, Map<String,Object>tokens) throws Exception{	
 	...
 	protected<T extends BaseEntity> void addActions(OmsUserContext userContext, SecUser secUser, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(OmsUserContext userContext, SecUser secUser, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingSecUser(OmsUserContext userContext,String secUserId, int secUserVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public SecUser clone(OmsUserContext userContext, String fromSecUserId) throws Exception{
	...
	public SecUser internalSaveSecUser(OmsUserContext userContext, SecUser secUser, Map<String,Object> options) throws Exception 
	{
	...
	public SecUser updateSecUserProperty(OmsUserContext userContext,String secUserId, int secUserVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingSecUser(userContext, secUserId, secUserVersion, property, newValueExpr, tokensExpr);
	...
	private static final String [] STATUS_SEQUENCE={"BLOCKED"};
 	protected String[] getNextCandidateStatus(OmsUserContext userContext, String currentStatus) throws Exception{
 	...
 	protected void ensureStatus(OmsUserContext userContext, SecUser secUser, String expectedNextStatus) throws Exception{
	...
	protected void checkParamsForTransferingAnotherDomain(OmsUserContext userContext, String secUserId, String anotherDomainId) throws Exception
 	{
	...
	public CandidateUserDomain requestCandidateDomain(OmsUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 	...
 	protected void checkParamsForTransferingAnotherBlocking(OmsUserContext userContext, String secUserId, String anotherBlockingId) throws Exception
 	{
 	...
 	public SecUser transferToAnotherBlocking(OmsUserContext userContext, String secUserId, String anotherBlockingId) throws Exception
 	{
	...
	public CandidateSecUserBlocking requestCandidateBlocking(OmsUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
	...
	public static final String BLOCKED_STATUS = "BLOCKED";
 	protected void checkParamsForBlocking(OmsUserContext userContext, String secUserId, String who, String comments
) throws Exception
 	{
 				userContext.getChecker().checkIdOfSecUser(secUserId);
 	...
 	public SecUserForm blockActionForm(OmsUserContext userContext, String secUserId) throws Exception
 	{
 	...
 	protected SecUserBlocking createBlocking(OmsUserContext userContext, String who, String comments){
 	...
 	protected void checkIfEligibleForBlocking(OmsUserContext userContext, SecUser secUser) throws Exception{
...
//--------------------------------------------------------------
 	...
 	protected SecUserBlocking loadSecUserBlocking(OmsUserContext userContext, String newBlockingId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(OmsUserContext userContext, String secUserId, int secUserVersion) throws Exception {
	...
	public SecUser forgetByAll(OmsUserContext userContext, String secUserId, int secUserVersion) throws Exception {
		return forgetByAllInternal(userContext, secUserId, secUserVersion);		
	}
	protected SecUser forgetByAllInternal(OmsUserContext userContext,
			String secUserId, int secUserVersion) throws Exception{
	...
	protected SecUser breakWithUserAppByObjectId(OmsUserContext userContext, String secUserId, String objectIdId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForAddingUserApp(OmsUserContext userContext, String secUserId, String title, String appIcon, boolean fullAccess, String permission, String objectType, String objectId, String location,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingUserAppProperties(OmsUserContext userContext, String secUserId,String id,String title,String appIcon,boolean fullAccess,String permission,String objectType,String objectId,String location,String [] tokensExpr) throws Exception {
	...
	public  SecUser updateUserAppProperties(OmsUserContext userContext, String secUserId, String id,String title,String appIcon,boolean fullAccess,String permission,String objectType,String objectId,String location, String [] tokensExpr) throws Exception
	{	
	...
	protected UserApp createUserApp(OmsUserContext userContext, String title, String appIcon, boolean fullAccess, String permission, String objectType, String objectId, String location) throws Exception{
	...
	protected void checkParamsForRemovingUserAppList(OmsUserContext userContext, String secUserId, 
	...
	public  SecUser removeUserAppList(OmsUserContext userContext, String secUserId, 
			String userAppIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingUserApp(OmsUserContext userContext, String secUserId, 
	...
	public  SecUser removeUserApp(OmsUserContext userContext, String secUserId, 
		String userAppId, int userAppVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingUserApp(OmsUserContext userContext, String secUserId, 
		String userAppId, int userAppVersion,String [] tokensExpr) throws Exception{
	...
	public  SecUser copyUserAppFrom(OmsUserContext userContext, String secUserId, 
		String userAppId, int userAppVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingUserApp(OmsUserContext userContext, String secUserId, String userAppId, int userAppVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  SecUser updateUserApp(OmsUserContext userContext, String secUserId, String userAppId, int userAppVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingLoginHistory(OmsUserContext userContext, String secUserId, String fromIp, String description,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingLoginHistoryProperties(OmsUserContext userContext, String secUserId,String id,String fromIp,String description,String [] tokensExpr) throws Exception {
	...
	public  SecUser updateLoginHistoryProperties(OmsUserContext userContext, String secUserId, String id,String fromIp,String description, String [] tokensExpr) throws Exception
	{	
	...
	protected LoginHistory createLoginHistory(OmsUserContext userContext, String fromIp, String description) throws Exception{
	...
	protected void checkParamsForRemovingLoginHistoryList(OmsUserContext userContext, String secUserId, 
	...
	public  SecUser removeLoginHistoryList(OmsUserContext userContext, String secUserId, 
			String loginHistoryIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingLoginHistory(OmsUserContext userContext, String secUserId, 
	...
	public  SecUser removeLoginHistory(OmsUserContext userContext, String secUserId, 
		String loginHistoryId, int loginHistoryVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingLoginHistory(OmsUserContext userContext, String secUserId, 
		String loginHistoryId, int loginHistoryVersion,String [] tokensExpr) throws Exception{
	...
	public  SecUser copyLoginHistoryFrom(OmsUserContext userContext, String secUserId, 
		String loginHistoryId, int loginHistoryVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingLoginHistory(OmsUserContext userContext, String secUserId, String loginHistoryId, int loginHistoryVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  SecUser updateLoginHistory(OmsUserContext userContext, String secUserId, String loginHistoryId, int loginHistoryVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
