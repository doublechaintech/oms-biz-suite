...
public class FormActionManagerImpl extends CustomOmsCheckerManager implements FormActionManager {
	...
	protected void throwExceptionWithMessage(String value) throws FormActionManagerException{
 	...
 	protected FormAction saveFormAction(OmsUserContext userContext, FormAction formAction, String [] tokensExpr) throws Exception{	
 	...
 	protected FormAction saveFormActionDetail(OmsUserContext userContext, FormAction formAction) throws Exception{	
 	...
 	public FormAction loadFormAction(OmsUserContext userContext, String formActionId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public FormAction searchFormAction(OmsUserContext userContext, String formActionId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected FormAction present(OmsUserContext userContext, FormAction formAction, Map<String, Object> tokens) throws Exception {
 	...
 	public FormAction loadFormActionDetail(OmsUserContext userContext, String formActionId) throws Exception{	
 		FormAction formAction = loadFormAction( userContext, formActionId, allTokens());
 		return present(userContext,formAction, allTokens());
		
 	}
 	
 	public Object view(OmsUserContext userContext, String formActionId) throws Exception{	
 		FormAction formAction = loadFormAction( userContext, formActionId, viewTokens());
 		return present(userContext,formAction, allTokens());
		
 	}
 	protected FormAction saveFormAction(OmsUserContext userContext, FormAction formAction, Map<String,Object>tokens) throws Exception{	
 		return userContext.getDAOGroup().getFormActionDAO().save(formAction, tokens);
 	}
 	protected FormAction loadFormAction(OmsUserContext userContext, String formActionId, Map<String,Object>tokens) throws Exception{	
		userContext.getChecker().checkIdOfFormAction(formActionId);
		userContext.getChecker().throwExceptionIfHasErrors( FormActionManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(OmsUserContext userContext, FormAction formAction, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(OmsUserContext userContext, FormAction formAction, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingFormAction(OmsUserContext userContext,String formActionId, int formActionVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public FormAction clone(OmsUserContext userContext, String fromFormActionId) throws Exception{
	...
	public FormAction internalSaveFormAction(OmsUserContext userContext, FormAction formAction, Map<String,Object> options) throws Exception 
	{
	...
	public FormAction updateFormActionProperty(OmsUserContext userContext,String formActionId, int formActionVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingFormAction(userContext, formActionId, formActionVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherForm(OmsUserContext userContext, String formActionId, String anotherFormId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(OmsUserContext userContext, String formActionId, int formActionVersion) throws Exception {
	...
	public FormAction forgetByAll(OmsUserContext userContext, String formActionId, int formActionVersion) throws Exception {
		return forgetByAllInternal(userContext, formActionId, formActionVersion);		
	}
	protected FormAction forgetByAllInternal(OmsUserContext userContext,
			String formActionId, int formActionVersion) throws Exception{
