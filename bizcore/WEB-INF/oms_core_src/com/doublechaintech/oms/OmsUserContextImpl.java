...
import com.doublechaintech.oms.secuser.SecUserCustomManagerImpl;
...
public class OmsUserContextImpl extends UserContextImpl implements OmsUserContext{
	...
	static final String RESOURCE_PATH="com.doublechaintech.oms.OmsResources";
	static final String CUSTOM_RESOURCE_PATH="com.doublechaintech.oms.OmsCustomResources";
    ...
    /*
    public static SecUser getSecUser(OmsUserContext userContext) {
	...
	public static UserApp getSingleUserAppByObjectName(OmsUserContext userContext, String objectName)
			throws Exception {
		SecUserCustomManagerImpl secUserManager = (SecUserCustomManagerImpl) userContext.getManagerGroup()
				.getSecUserManager();
		SecUser secUser = secUserManager.getCachedSecUser(userContext);
	...
	*/
	public static SmartList<UserApp> getUserAppByName(OmsUserContext userContext, SecUser secUser, String objectName) {
	...
	public static UserApp getUserAppByBindedEntity(OmsUserContext userContext, BaseEntity userAppBindedObject) {
		MultipleAccessKey key = new MultipleAccessKey();
