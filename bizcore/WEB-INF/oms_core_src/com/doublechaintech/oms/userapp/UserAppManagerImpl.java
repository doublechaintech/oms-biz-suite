...
public class UserAppManagerImpl extends CustomOmsCheckerManager implements UserAppManager {
	...
	protected void throwExceptionWithMessage(String value) throws UserAppManagerException{
 	...
 	protected UserApp saveUserApp(OmsUserContext userContext, UserApp userApp, String [] tokensExpr) throws Exception{	
 	...
 	protected UserApp saveUserAppDetail(OmsUserContext userContext, UserApp userApp) throws Exception{	
 	...
 	public UserApp loadUserApp(OmsUserContext userContext, String userAppId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public UserApp searchUserApp(OmsUserContext userContext, String userAppId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected UserApp present(OmsUserContext userContext, UserApp userApp, Map<String, Object> tokens) throws Exception {
 	...
 	public UserApp loadUserAppDetail(OmsUserContext userContext, String userAppId) throws Exception{	
 		UserApp userApp = loadUserApp( userContext, userAppId, allTokens());
 		return present(userContext,userApp, allTokens());
		
 	}
 	
 	public Object view(OmsUserContext userContext, String userAppId) throws Exception{	
 		UserApp userApp = loadUserApp( userContext, userAppId, viewTokens());
 		return present(userContext,userApp, allTokens());
		
 	}
 	protected UserApp saveUserApp(OmsUserContext userContext, UserApp userApp, Map<String,Object>tokens) throws Exception{	
 		return userContext.getDAOGroup().getUserAppDAO().save(userApp, tokens);
 	}
 	protected UserApp loadUserApp(OmsUserContext userContext, String userAppId, Map<String,Object>tokens) throws Exception{	
		userContext.getChecker().checkIdOfUserApp(userAppId);
		userContext.getChecker().throwExceptionIfHasErrors( UserAppManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(OmsUserContext userContext, UserApp userApp, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(OmsUserContext userContext, UserApp userApp, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingUserApp(OmsUserContext userContext,String userAppId, int userAppVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public UserApp clone(OmsUserContext userContext, String fromUserAppId) throws Exception{
	...
	public UserApp internalSaveUserApp(OmsUserContext userContext, UserApp userApp, Map<String,Object> options) throws Exception 
	{
	...
	public UserApp updateUserAppProperty(OmsUserContext userContext,String userAppId, int userAppVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingUserApp(userContext, userAppId, userAppVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherSecUser(OmsUserContext userContext, String userAppId, String anotherSecUserId) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithLogin(OmsUserContext userContext, String userAppId, String anotherLogin) throws Exception
 	{
 	...
 	public UserApp transferToAnotherSecUserWithLogin(OmsUserContext userContext, String userAppId, String anotherLogin) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithEmail(OmsUserContext userContext, String userAppId, String anotherEmail) throws Exception
 	{
 	...
 	public UserApp transferToAnotherSecUserWithEmail(OmsUserContext userContext, String userAppId, String anotherEmail) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithMobile(OmsUserContext userContext, String userAppId, String anotherMobile) throws Exception
 	{
 	...
 	public UserApp transferToAnotherSecUserWithMobile(OmsUserContext userContext, String userAppId, String anotherMobile) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(OmsUserContext userContext, String userAppId, int userAppVersion) throws Exception {
	...
	public UserApp forgetByAll(OmsUserContext userContext, String userAppId, int userAppVersion) throws Exception {
		return forgetByAllInternal(userContext, userAppId, userAppVersion);		
	}
	protected UserApp forgetByAllInternal(OmsUserContext userContext,
			String userAppId, int userAppVersion) throws Exception{
	...
	protected void checkParamsForAddingListAccess(OmsUserContext userContext, String userAppId, String name, String internalName, boolean readPermission, boolean createPermission, boolean deletePermission, boolean updatePermission, boolean executionPermission,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingListAccessProperties(OmsUserContext userContext, String userAppId,String id,String name,String internalName,boolean readPermission,boolean createPermission,boolean deletePermission,boolean updatePermission,boolean executionPermission,String [] tokensExpr) throws Exception {
	...
	public  UserApp updateListAccessProperties(OmsUserContext userContext, String userAppId, String id,String name,String internalName,boolean readPermission,boolean createPermission,boolean deletePermission,boolean updatePermission,boolean executionPermission, String [] tokensExpr) throws Exception
	{	
	...
	protected ListAccess createListAccess(OmsUserContext userContext, String name, String internalName, boolean readPermission, boolean createPermission, boolean deletePermission, boolean updatePermission, boolean executionPermission) throws Exception{
	...
	protected void checkParamsForRemovingListAccessList(OmsUserContext userContext, String userAppId, 
	...
	public  UserApp removeListAccessList(OmsUserContext userContext, String userAppId, 
			String listAccessIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingListAccess(OmsUserContext userContext, String userAppId, 
	...
	public  UserApp removeListAccess(OmsUserContext userContext, String userAppId, 
		String listAccessId, int listAccessVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingListAccess(OmsUserContext userContext, String userAppId, 
		String listAccessId, int listAccessVersion,String [] tokensExpr) throws Exception{
	...
	public  UserApp copyListAccessFrom(OmsUserContext userContext, String userAppId, 
		String listAccessId, int listAccessVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingListAccess(OmsUserContext userContext, String userAppId, String listAccessId, int listAccessVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  UserApp updateListAccess(OmsUserContext userContext, String userAppId, String listAccessId, int listAccessVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingObjectAccess(OmsUserContext userContext, String userAppId, String name, String objectType, String list1, String list2, String list3, String list4, String list5, String list6, String list7, String list8, String list9,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingObjectAccessProperties(OmsUserContext userContext, String userAppId,String id,String name,String objectType,String list1,String list2,String list3,String list4,String list5,String list6,String list7,String list8,String list9,String [] tokensExpr) throws Exception {
	...
	public  UserApp updateObjectAccessProperties(OmsUserContext userContext, String userAppId, String id,String name,String objectType,String list1,String list2,String list3,String list4,String list5,String list6,String list7,String list8,String list9, String [] tokensExpr) throws Exception
	{	
	...
	protected ObjectAccess createObjectAccess(OmsUserContext userContext, String name, String objectType, String list1, String list2, String list3, String list4, String list5, String list6, String list7, String list8, String list9) throws Exception{
	...
	protected void checkParamsForRemovingObjectAccessList(OmsUserContext userContext, String userAppId, 
	...
	public  UserApp removeObjectAccessList(OmsUserContext userContext, String userAppId, 
			String objectAccessIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingObjectAccess(OmsUserContext userContext, String userAppId, 
	...
	public  UserApp removeObjectAccess(OmsUserContext userContext, String userAppId, 
		String objectAccessId, int objectAccessVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingObjectAccess(OmsUserContext userContext, String userAppId, 
		String objectAccessId, int objectAccessVersion,String [] tokensExpr) throws Exception{
	...
	public  UserApp copyObjectAccessFrom(OmsUserContext userContext, String userAppId, 
		String objectAccessId, int objectAccessVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingObjectAccess(OmsUserContext userContext, String userAppId, String objectAccessId, int objectAccessVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  UserApp updateObjectAccess(OmsUserContext userContext, String userAppId, String objectAccessId, int objectAccessVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
