<%@ page import='java.util.*,com.doublechaintech.oms.*,com.doublechaintech.oms.genericform.GenericForm'%>
...
<sky:include page="com/doublechaintech/oms/genericform/GenericForm$Summary.jsp" />
		...
		<div id="formMessageList" class="tab-pane fade sublist" refer-name="form">
			<sky:include page="com/doublechaintech/oms/formmessage/FormMessage$List.jsp"
					referName="form"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["formFieldMessageList"] or ignoreListAccessControl}'>
		...
		<div id="formFieldMessageList" class="tab-pane fade sublist" refer-name="form">
			<sky:include page="com/doublechaintech/oms/formfieldmessage/FormFieldMessage$List.jsp"
					referName="form"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["formFieldList"] or ignoreListAccessControl}'>
		...
		<div id="formFieldList" class="tab-pane fade sublist" refer-name="form">
			<sky:include page="com/doublechaintech/oms/formfield/FormField$List.jsp"
					referName="form"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["formActionList"] or ignoreListAccessControl}'>
		...
		<div id="formActionList" class="tab-pane fade sublist" refer-name="form">
			<sky:include page="com/doublechaintech/oms/formaction/FormAction$List.jsp"
					referName="form"/>
		</div>
	</c:if>
