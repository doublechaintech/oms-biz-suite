<%@ page import='java.util.*,com.doublechaintech.oms.*,com.doublechaintech.oms.formmessage.FormMessage'%>
...
<sky:include page="com/doublechaintech/oms/formmessage/FormMessage$Summary.jsp" />
