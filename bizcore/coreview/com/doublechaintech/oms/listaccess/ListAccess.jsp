<%@ page import='java.util.*,com.doublechaintech.oms.*,com.doublechaintech.oms.listaccess.ListAccess'%>
...
<sky:include page="com/doublechaintech/oms/listaccess/ListAccess$Summary.jsp" />
