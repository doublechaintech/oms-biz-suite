<%@ page import='java.util.*,com.doublechaintech.oms.*,com.doublechaintech.oms.profile.Profile'%>
...
<sky:include page="com/doublechaintech/oms/profile/Profile$Summary.jsp" />
