...
<div class="col-xs-12 col-ms-6 col-md-4 section">
	...
	<b title="A OrderPromotion">${userContext.localeMap['order_promotion']} </b><a href="#"><i class="fa fa-refresh" aria-hidden="true"></i></a>
	<hr/>
	<ul>
	
	
	<li><span>ID</span><a class="link-action-removed" href="./orderPromotionManager/view/${orderPromotion.id}/"> ${orderPromotion.id}</a></li>
