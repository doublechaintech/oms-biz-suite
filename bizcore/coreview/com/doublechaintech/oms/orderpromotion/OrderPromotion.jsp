<%@ page import='java.util.*,com.doublechaintech.oms.*,com.doublechaintech.oms.orderpromotion.OrderPromotion'%>
...
<sky:include page="com/doublechaintech/oms/orderpromotion/OrderPromotion$Summary.jsp" />
