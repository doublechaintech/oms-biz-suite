<%@ page import='java.util.*,com.doublechaintech.oms.*,com.doublechaintech.oms.userapp.UserApp'%>
...
<sky:include page="com/doublechaintech/oms/userapp/UserApp$Summary.jsp" />
...
<sky:include page="com/doublechaintech/oms/secuser/SecUser$Info.jsp" />
		...
		<div id="listAccessList" class="tab-pane fade sublist" refer-name="app">
			<sky:include page="com/doublechaintech/oms/listaccess/ListAccess$List.jsp"
					referName="app"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["objectAccessList"] or ignoreListAccessControl}'>
		...
		<div id="objectAccessList" class="tab-pane fade sublist" refer-name="app">
			<sky:include page="com/doublechaintech/oms/objectaccess/ObjectAccess$List.jsp"
					referName="app"/>
		</div>
	</c:if>
