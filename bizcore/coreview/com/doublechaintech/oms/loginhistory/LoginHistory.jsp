<%@ page import='java.util.*,com.doublechaintech.oms.*,com.doublechaintech.oms.loginhistory.LoginHistory'%>
...
<sky:include page="com/doublechaintech/oms/loginhistory/LoginHistory$Summary.jsp" />
