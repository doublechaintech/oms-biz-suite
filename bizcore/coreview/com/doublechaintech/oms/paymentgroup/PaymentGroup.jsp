<%@ page import='java.util.*,com.doublechaintech.oms.*,com.doublechaintech.oms.paymentgroup.PaymentGroup'%>
...
<sky:include page="com/doublechaintech/oms/paymentgroup/PaymentGroup$Summary.jsp" />
