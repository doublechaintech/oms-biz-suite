<%@ page import='java.util.*,com.doublechaintech.oms.*,com.doublechaintech.oms.secuser.SecUser'%>
...
<sky:include page="com/doublechaintech/oms/secuser/SecUser$Summary.jsp" />
...
<sky:include page="com/doublechaintech/oms/userdomain/UserDomain$Info.jsp" />
...
<sky:include page="com/doublechaintech/oms/secuserblocking/SecUserBlocking$Action.jsp" />
		...
		<div id="userAppList" class="tab-pane fade sublist" refer-name="sec_user">
			<sky:include page="com/doublechaintech/oms/userapp/UserApp$List.jsp"
					referName="secUser"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["loginHistoryList"] or ignoreListAccessControl}'>
		...
		<div id="loginHistoryList" class="tab-pane fade sublist" refer-name="sec_user">
			<sky:include page="com/doublechaintech/oms/loginhistory/LoginHistory$List.jsp"
					referName="secUser"/>
		</div>
	</c:if>
