<%@ page import='java.util.*,com.doublechaintech.oms.*,com.doublechaintech.oms.userwhitelist.UserWhiteList'%>
...
<sky:include page="com/doublechaintech/oms/userwhitelist/UserWhiteList$Summary.jsp" />
