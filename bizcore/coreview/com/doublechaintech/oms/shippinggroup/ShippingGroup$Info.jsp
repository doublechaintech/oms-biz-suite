...
<div class="col-xs-12 col-ms-6 col-md-4 section">
	...
	<b title="A ShippingGroup">${userContext.localeMap['shipping_group']} </b><a href="#"><i class="fa fa-refresh" aria-hidden="true"></i></a>
	<hr/>
	<ul>
	
	
	<li><span>ID</span><a class="link-action-removed" href="./shippingGroupManager/view/${shippingGroup.id}/"> ${shippingGroup.id}</a></li>
