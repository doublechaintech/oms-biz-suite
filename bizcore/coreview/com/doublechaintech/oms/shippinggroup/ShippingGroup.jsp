<%@ page import='java.util.*,com.doublechaintech.oms.*,com.doublechaintech.oms.shippinggroup.ShippingGroup'%>
...
<sky:include page="com/doublechaintech/oms/shippinggroup/ShippingGroup$Summary.jsp" />
