<%@ page import='java.util.*,com.doublechaintech.oms.*,com.doublechaintech.oms.platform.Platform'%>
...
<sky:include page="com/doublechaintech/oms/platform/Platform$Summary.jsp" />
